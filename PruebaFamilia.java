...
public class PruebaFamilia {
    public static void main(String[] args) {
        ...
        for (int x = 0; x < 2; x++) {
            ...
            System.out.print("Ingrese su rol en la familia: ");
            rol = input1.next();

            System.out.print("Ingrese su # de casa:  ");
            casa = input.next();
            ...
            fam = new Familia(rol, person);
            direction = new Direccion(casa, calle, barrio, ciudad, fam);
